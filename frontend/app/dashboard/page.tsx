        ...
        <div className="w-full px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Productreevity</h1>
                <p className="text-sm text-gray-600 dark:text-gray-300">Welcome back, {user.username}!</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right">
                ...
                <p className="text-xl font-bold text-green-600">{user.totalPoints.toLocaleString()}</p>
              </div>
              <div className="text-right">
                <p className="text-sm text-gray-600 dark:text-gray-300">Current Streak</p>
                <p className="text-xl font-bold text-orange-600">{user.currentStreak} days</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
                  <div className="grid grid-cols-4 gap-4">
                    <div className="text-center">
                      <div className="w-10 h-10 bg-gradient-to-br from-red-400 to-red-600 rounded-full mx-auto mb-2 shadow-lg"></div>
                      <p className="text-sm font-medium">Red</p>
                      <p className="text-lg font-bold text-red-600">{tree.redApples}</p>
                    </div>
                    <div className="text-center">
                      <div className="w-10 h-10 bg-gradient-to-br from-gray-300 to-gray-500 rounded-full mx-auto mb-2 shadow-lg"></div>
                      <p className="text-sm font-medium">Silver</p>
                      <p className="text-lg font-bold text-gray-600">{tree.silverApples}</p>
                    </div>
                    <div className="text-center">
                      <div className="w-10 h-10 bg-gradient-to-br from-yellow-300 to-yellow-600 rounded-full mx-auto mb-2 shadow-lg"></div>
                      <p className="text-sm font-medium">Gold</p>
                      <p className="text-lg font-bold text-yellow-600">{tree.goldApples}</p>
                    </div>
                    <div className="text-center">
                      <div className="w-10 h-10 bg-gradient-to-br from-blue-300 to-blue-600 rounded-full mx-auto mb-2 shadow-lg"></div>
                      <p className="text-sm font-medium">Diamond</p>
                      <p className="text-lg font-bold text-blue-600">{tree.diamondApples}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
